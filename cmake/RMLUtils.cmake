...
#################################################
macro (rml_add_library _name)
  add_library(${_name} SHARED ${ARGN})
  target_link_libraries (${_name} ${general_libraries})
endmacro ()

#################################################
macro (rml_add_executable _name)
...
#################################################
macro (rml_install_includes _subdir)
  install(FILES ${ARGN} DESTINATION ${INCLUDE_INSTALL_DIR}/${_subdir} COMPONENT headers)
endmacro()

#################################################
macro (rml_install_library _name)
  set_target_properties(${_name} PROPERTIES SOVERSION ${RML_MAJOR_VERSION} VERSION ${RML_VERSION_FULL})
  install (TARGETS ${_name} DESTINATION ${LIB_INSTALL_DIR} COMPONENT shlib)
endmacro ()

#################################################
macro (rml_install_executable _name)
  set_target_properties(${_name} PROPERTIES VERSION ${RML_VERSION_FULL})
  install (TARGETS ${_name} DESTINATION ${BIN_INSTALL_DIR})
endmacro ()

#################################################
macro (rml_setup_unix)
endmacro()

#################################################
macro (rml_setup_windows)
endmacro()

#################################################
macro (rml_setup_apple)
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} -Wl,-undefined -Wl,dynamic_lookup")
endmacro()

#################################################
include_directories(${PROJECT_SOURCE_DIR}/test/gtest/include)
macro (rml_build_tests)
  # Build all the tests
